...
class GameOverController extends GetxController {
  ...
  late dynamic showHighScore = _storage.read("high score hard") ?? 0;
  ...
  Future<void> storeFinalScore() async {
    try {
      ...
      dynamic highScore = userDoc.get("high score hard");
      if (realTime > highScore) {
        _authCollection.doc(userToken).update({'high score hard': realTime});
      }
      print("high score hard:  $highScore");
